...
export const createContentPage: RequestHandler = async (req, res) => {
  try {
    ...
    const result = await db.collection("content_pages").insertOne(newPage);
...
export const initializeContentPages: RequestHandler = async (req, res) => {
  try {
    ...
    const existingPagesCount = await db
      .collection("content_pages")
      .countDocuments();
    ...
    const defaultPages: Omit<ContentPage, "_id">[] = [
      {
        ...
        `,
        metaTitle: "About Us - Aashish Property | Trusted Real Estate Partner in Rohtak",
        metaDescription: "Learn more about Aashish Property, your trusted real estate partner in Rohtak. We provide residential and commercial property solutions with exceptional service.",
        status: "published",
        type: "page",
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        ...
        metaDescription: "Read our privacy policy to understand how Aashish Property collects, uses, and protects your personal information.",
        status: "published",
        type: "policy",
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        ...
        metaDescription: "Read the terms and conditions for using Aashish Property platform and services.",
        status: "published",
        type: "terms",
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        ...
        metaDescription: "Understanding our refund policy for Aashish Property services and charges.",
        status: "published",
        type: "policy",
        createdAt: new Date(),
        updatedAt: new Date(),
    ...
    await db.collection("content_pages").insertMany(defaultPages);
