...
export default function FooterUpdateNotification({ className = "" }: FooterUpdateNotificationProps) {
  ...
  useEffect(() => {
    ...
    const handlePageCreate = () => {
      const notification = {
        ...
        message: '✅ Page published! It will appear in the footer automatically.',
        timestamp: new Date()
      };
  ...
  const getIcon = (type: string) => {
    switch (type) {
      ...
      case 'info': return <RefreshCw className="h-4 w-4 text-blue-600" />;
