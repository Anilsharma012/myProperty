...
export default function EnhancedCategoryManagement() {
  ...
  const [newCategory, setNewCategory] = useState({
    ...
    subcategories: [] as { name: string; slug: string; description: string; imageFile?: File }[],
    order: 999,
    active: true,
  });
  ...
  const addSubcategory = () => {
    setNewCategory({
      ...newCategory,
      subcategories: [...newCategory.subcategories, { name: "", slug: "", description: "" }]
    });
  };

  const updateSubcategory = (index: number, field: string, value: string | File) => {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          <h3 className="text-2xl font-bold text-gray-900">Enhanced Category Management</h3>
          <p className="text-gray-600">Complete control over categories, subcategories, icons, and display order</p>
        </div>
        <Button 
                ...
                <TableRow key={category._id}>
                  <TableCell className="font-medium">
                    <div>
                      ...
                      <code className="text-xs bg-gray-100 px-1 rounded">{category.slug}</code>
                    </div>
                  </TableCell>
                  <TableCell>
                    {category.icon ? (
                      <div className="w-8 h-8 bg-red-50 border border-red-100 rounded-lg flex items-center justify-center">
                        {category.icon.startsWith('http') ? (
                          <img src={category.icon} alt="Category icon" className="w-6 h-6 object-cover rounded" />
                        ) : (
                  ...
                  <TableCell>
                    <div className="flex items-center space-x-2">
                      <Switch
                        ...
                        onCheckedChange={(checked) => toggleCategoryStatus(category._id, checked)}
                      />
                      <Badge
                    ...
                    <div className="flex items-center space-x-1">
                      ...
                      <div className="flex flex-col">
                        <Button
                          size="sm"
                          variant="ghost"
                          onClick={() => updateCategoryOrder(category._id, "up")}
                          disabled={index === 0}
                        ...
                        <Button
                          size="sm"
                          variant="ghost"
                          onClick={() => updateCategoryOrder(category._id, "down")}
      ...
      <Dialog open={isCreateDialogOpen} onOpenChange={(open) => {
        ...
        <DialogContent className="max-w-4xl max-h-[80vh] overflow-y-auto">
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label className="block text-sm font-medium mb-2">Icon URL or Emoji</label>
                <Input
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => setNewCategory({ ...newCategory, order: parseInt(e.target.value) || 999 })}
